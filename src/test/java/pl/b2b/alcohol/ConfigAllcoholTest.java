...
public class ConfigAllcoholTest {
    ...
    @Test
    public void mostPromils() {
        assertEquals("a", configAllcohol.mostPromils(piwa));
        assertEquals("a", configAllcohol.mostPromils(wina));
        assertEquals("a", configAllcohol.mostPromils(wodki));
    }

    @Test
    public void lowestPromils() {
        assertEquals("a", configAllcohol.lowestPromils(piwa));
        assertEquals("a", configAllcohol.lowestPromils(wina));
        assertEquals("a", configAllcohol.lowestPromils(wodki));
    }
