...
import pl.b2b.alcohol.ConfigAllcohol;
import pl.b2b.alcohol.TypeOfAlcohol;
...
public class App
{
    public static void main( String[] args )
    {
        ...
        ConfigAllcohol configAllcohol = new ConfigAllcohol();

        System.out.println(configAllcohol.mostExpensiveAlcohol(piwa));
        System.out.println(configAllcohol.mostExpensiveAlcohol(wina));
        System.out.println(configAllcohol.mostExpensiveAlcohol(wodki));
